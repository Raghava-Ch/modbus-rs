...
static STEPS: &[Step] = &[
    ...
    Step::check(
        "client / coils+registers+traffic",
        &[
            "-p",
            "mbus-client",
            "--no-default-features",
    ...
    Step::check(
        "server / coils+holding-registers",
        &[
            "-p",
            "mbus-server",
            "--no-default-features",
    ...
    Step::clippy(
        "server / coils+holding-registers (clippy)",
        &[
            "-p",
            "mbus-server",
            "--no-default-features",
    ...
    Step::check(
        "server / example discrete_inputs",
        &[
            "-p",
            "mbus-server",
            "--example",
    ...
    Step::check(
        "server / example discrete_inputs_read",
        &[
            "-p",
            "mbus-server",
            "--example",
    ...
    Step::check(
        "server / example holding_registers_read",
        &[
            "-p",
            "mbus-server",
            "--example",
    ...
    Step::check(
        "server / example read_write_registers",
        &[
            "-p",
            "mbus-server",
            "--example",
    ...
    // integration tests
    Step::test(
        "server / test fc01 (coils)",
        &[
            "-p",
            "mbus-server",
            "--test",
            "fc01_fc05_fc15_integration",
            "--no-default-features",
            "--features",
            "coils",
        ],
    ...
    Step::test(
        "server / test fc03 (holding-registers)",
        &[
            "-p",
            "mbus-server",
            "--test",
            "fc03_validation_guards",
            "--no-default-features",
            "--features",
            "holding-registers",
        ],
    ...
    Step::test(
        "server / test fc04/fc06/fc16 (input+holding-registers)",
        &[
            "-p",
            "mbus-server",
            "--test",
            "fc04_fc06_fc16_integration",
            "--no-default-features",
            "--features",
    ...
    Step::test(
        "server / test fc17 (holding-registers)",
        &[
            "-p",
            "mbus-server",
            "--test",
    ...
    Step::test(
        "server / test fc14/fc15 (file-record)",
        &[
            "-p",
            "mbus-server",
            "--test",
            "fc14_fc15_integration",
            "--no-default-features",
            "--features",
            "file-record",
        ],
    ...
    Step::test(
        "server / test fc0b/fc0c/fc11 (diagnostics)",
        &[
            "-p",
            "mbus-server",
            "--test",
            "fc0b_fc0c_fc11_integration",
            "--no-default-features",
            "--features",
            "diagnostics",
        ],
    ...
    Step::check(
        "async / network-tcp+coils+registers",
        &[
            "-p",
            "mbus-async",
            "--no-default-features",
    ...
    Step::check(
        "async / network-tcp+coils+traffic",
        &[
            "-p",
            "mbus-async",
            "--no-default-features",
            "--features",
            "network-tcp,coils,traffic",
        ],
    ),
    Step::check(
        "async / network-tcp+registers+traffic",
        &[
            "-p",
            "mbus-async",
            "--no-default-features",
    ...
    Step::clippy(
        "async / network-tcp+coils (clippy)",
        &[
            "-p",
            "mbus-async",
            "--no-default-features",
    ...
    Step::clippy(
        "async / network-tcp+registers (clippy)",
        &[
            "-p",
            "mbus-async",
            "--no-default-features",
    ...
    Step::clippy(
        "async / network-tcp+coils+registers (clippy)",
        &[
            "-p",
            "mbus-async",
            "--no-default-features",
    ...
    Step::build(
        "async / network-tcp+coils+registers build",
        &[
            "-p",
            "mbus-async",
            "--no-default-features",
    ...
    Step::clippy(
        "gateway / network+serial-rtu (clippy)",
        &[
            "-p",
            "mbus-gateway",
            "--no-default-features",
...
pub fn cmd_check_feature_subsets(root: &Path, opts: &Opts) -> Result<(), String> {
    ...
    let mode = if opts.fast {
        " [fast mode — build/test skipped]"
    } else {
        ""
    };
