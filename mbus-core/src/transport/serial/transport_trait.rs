...
pub enum ModbuSerialTransportError {
...
impl From<ModbuSerialTransportError> for MbusError {
    fn from(err: ModbuSerialTransportError) -> Self {
        match err {
            ModbuSerialTransportError::ConnectionFailed => MbusError::ConnectionFailed,
            ModbuSerialTransportError::ConnectionClosed => MbusError::ConnectionClosed,
            ModbuSerialTransportError::IoError => MbusError::IoError,
            ModbuSerialTransportError::Timeout => MbusError::Timeout,
            ModbuSerialTransportError::BufferTooSmall => MbusError::BufferTooSmall,
            ModbuSerialTransportError::Unexpected => MbusError::Unexpected,
        }
    }
}
...
pub trait ModbusSerialTransport {
