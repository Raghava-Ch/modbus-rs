...
```toml
[dependencies]
modbus-rs = { version = "0.11.0", default-features = false, features = ["client", "network-tcp", "coils"] }
```
...
```toml
[dependencies]
modbus-rs = { version = "0.11.0", default-features = false, features = ["client", "coils", "registers"] }
```
...
```toml
[dependencies]
mbus-core = { version = "0.11.0", default-features = false, features = ["coils", "registers"] }
```
