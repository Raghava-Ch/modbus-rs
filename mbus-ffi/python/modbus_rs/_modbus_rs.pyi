...
class CoilState:
    """Represents the binary on/off state of a Modbus coil or discrete input."""
    Off: CoilState
    On: CoilState
...
class TcpModbusClient:
    ...
    def __init__(self) -> None: ...
    # Coils
    def read_coils(self, address: int, quantity: int) -> list[CoilState]: ...
    def write_coil(self, address: int, value: CoilState) -> tuple[int, CoilState]: ...
    def write_coils(self, address: int, values: list[CoilState]) -> tuple[int, int]: ...
    # Discrete inputs
    def read_discrete_inputs(self, address: int, quantity: int) -> list[CoilState]: ...
    # Holding registers
...
class ModbusApp:
    ...
    def handle_read_coils(self, address: int, count: int) -> list[CoilState] | Awaitable[list[CoilState]]:
        """Return a list of ``count`` coil values starting at ``address``."""
        ...

    def handle_write_coil(self, address: int, value: CoilState) -> None | Awaitable[None]:
        """Set the coil at ``address`` to ``value``."""
        ...

    def handle_write_coils(self, address: int, values: list[CoilState]) -> None | Awaitable[None]:
        """Write multiple coils (FC15)."""
        ...

    def handle_read_discrete_inputs(self, address: int, count: int) -> list[CoilState] | Awaitable[list[CoilState]]:
